    ...
    <form method="get" action="{{ route('user.items.index') }}">
      <div class="lg:flex lg:justify-between">
        <div class="lg:flex items-end">
          <select name="category" class="mb-2 lg:mb-0 lg:mr-4">
            <option
              value="0" @if(\Request::get('category') === '0')
              selected @endif>全て
            </option>
          ...
          <div class="flex space-x-2 items-center">
            <div>
              <input name="keyword" type="text" placeholder="キーワード" class="border border-gray-500 py-2">
            </div>
            <div>
              <button class="ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">検索</button>
            </div>
          </div>
        </div>
        <div class="flex">
